...
>
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <!-- LOGO & APP NAME -->
        <a class="ml-6 flex items-center space-x-2 text-lg font-bold text-gray-800" href="{{ route('dashboard') }}">
            <img src="{{ asset('images/mtau.png') }}" alt="Logo MTAU" class="w-6 h-6">
            <span>MTAU Ticketing</span>
        </a>
